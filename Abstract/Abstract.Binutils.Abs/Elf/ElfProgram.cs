...
public class ElfBuilder(string pname) {
    ...
    public class ReferenceLumpBuilder(string kind, string identifier) : DirBuilder(kind, identifier) {
        ...
        public override string ToString()
        {
            ...
            str.AppendLine( $"#{kind} {identifier} ({references.Count} references)");
